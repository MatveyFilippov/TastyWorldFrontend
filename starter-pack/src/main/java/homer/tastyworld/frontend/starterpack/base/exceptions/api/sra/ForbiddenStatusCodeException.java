...
public class ForbiddenStatusCodeException  extends ErrorResponseStatusCodeException {

    public ForbiddenStatusCodeException(ClassicHttpResponse response, int expectedStatusCode, ErrorResponseBody errorResponseBody) {
