...
public class UnauthorizedStatusCodeException extends ErrorResponseStatusCodeException {

    public UnauthorizedStatusCodeException(ClassicHttpResponse response, int expectedStatusCode, ErrorResponseBody errorResponseBody) {
