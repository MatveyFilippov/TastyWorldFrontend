...
public class BadRequestStatusCodeException extends ErrorResponseStatusCodeException {

    public BadRequestStatusCodeException(ClassicHttpResponse response, int expectedStatusCode, ErrorResponseBody errorResponseBody) {
