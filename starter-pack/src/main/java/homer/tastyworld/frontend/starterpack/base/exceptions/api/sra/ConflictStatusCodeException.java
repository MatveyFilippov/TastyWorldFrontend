...
public class ConflictStatusCodeException extends ErrorResponseStatusCodeException {

    public ConflictStatusCodeException(ClassicHttpResponse response, int expectedStatusCode, ErrorResponseBody errorResponseBody) {
