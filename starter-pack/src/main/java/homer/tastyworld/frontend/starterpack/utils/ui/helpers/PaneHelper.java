...
public class PaneHelper {
    ...
    private static final CacheableFunction<String, Background> cacheableGetImageBackgroundCentre = CacheManager.getForFunction(
            url -> {
                try {
    ...
    private static final CacheableFunction<String, Background> cacheableGetImageBackgroundBottom = CacheManager.getForFunction(
            url -> {
                try {
    ...
    public static void setImageBackgroundCentre(AnchorPane pane, URL image) {
        pane.setBackground(cacheableGetImageBackgroundCentre.applyWithCache(image.toString()));
    }
    ...
    public static void setImageBackgroundBottom(AnchorPane pane, URL image) {
        pane.setBackground(cacheableGetImageBackgroundBottom.applyWithCache(image.toString()));
    }
