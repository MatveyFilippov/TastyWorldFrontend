...
public class VirtualKeyboardPrompts {
    ...
    private static final String USED_PROMPTS_FILE_EXTENSION = ".twvkbp";  // TastyWorldVirtualKeyboardPrompts
    ...
    static {
        FileDirectories.createDir(USED_PROMPTS_DIR);
    }
    ...
    private static AnchorPane createClickablePrompt(HBox promptsContainer, int index) {
        ...
        PROMPTS_PLACE[index] = AdaptiveTextHelper.setTextCentre(prompt, "", 0.065, Color.web("#555555"));
        return prompt;
    }
